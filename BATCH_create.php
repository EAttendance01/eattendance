...
<form method="post">
  <div class="container box">
    ...
    <p style="margin-top:60px;">CREATE BATCH</p>
    <hr>
    ...
    <input type=text placeholder="Enter Batch ID" name="BID" required>
	
    <label><b>Start Date</b></label>
    <input type=text placeholder="Enter Start Time" name="SDATE" required>
	
    <label><b>End Date</b></label>
    <input type=text placeholder="Enter End Time" name="EDATE" required>
	
    <label><b>Start Time</b></label>
    <input type=text placeholder="Enter START Time" name="STIME" required>
	
    <label><b>End Time</b></label>
    <input type=text placeholder="Enter End Time" name="ETIME" required>
...
if(isset($_POST['s']))
{
    ...
    $sql="insert into batches(TPID,TPCID,BID,SDATE,EDATE,STIME,ETIME,Description)values($TPID,$TPCID,$BID,$SDATE,$EDATE,$STIME,$ETIME,$Description)";	
