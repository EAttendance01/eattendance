...
<form method="post">
  <div class="container box">
    ...
    <p style="margin-top:60px;">ADD STUDENT</p>
    <hr>
    ...
    <input type=text placeholder="Choose Gender" name="Gender" required>

	<label><b>Remark</b></label>
    <input type=text placeholder="Add Remarks" name="Remark" required>
...
if(isset($_POST['s']))
{
	...
	$Gender="'".$_POST["Gender"]."'";
	$Remark="'".$_POST["Remark"]."'";
    $sql="insert into student(TPID,TPCID,BID,SName,CID,MName,Mobile,Gender,Remark)values($BID,$SName,$CID,$MName,$Mobile,$Gender,$Remark)";	
